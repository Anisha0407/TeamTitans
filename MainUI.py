...
#        Insert code here/ information to retrieve
        ...
        dataset_csv = pd.read_csv('CurrentTrends/final_csv/tshirts/tshirts_csv_final.csv',names=colnames, delimiter=',', header=None,usecols=reqdcolnames, na_values=" NaN")
...
#        Insert code here/ information to retrieve
        ...
        colnames=['sno','URL','id','desc','stars','num_ratings','num_reviews','reviews','vader_score','final_score']
        reqdcolnames=['id','stars','desc','URL','final_score']  
        dataset_csv = pd.read_csv('CurrentTrends/final_csv/dresses/dresses_csv_final.csv',names=colnames, delimiter=',', header=None,usecols=reqdcolnames, na_values=" NaN")
        dataset_csv = dataset_csv.dropna()
        dataset_csv2=dataset_csv.sort_values(by='final_score', ascending=False)
        dataset_csv2=dataset_csv2.reset_index()
        #print(dataset_csv2.head())
...
#        Insert code here/ information to retrieve
        ...
        colnames=['sno','URL','id','desc','stars','num_ratings','num_reviews','reviews','vader_score','final_score']
        reqdcolnames=['id','stars','desc','URL','final_score']  
        dataset_csv = pd.read_csv('CurrentTrends/final_csv/skirts/skirts_csv_final.csv',names=colnames, delimiter=',', header=None,usecols=reqdcolnames, na_values=" NaN")
        dataset_csv = dataset_csv.dropna()
        dataset_csv2=dataset_csv.sort_values(by='final_score', ascending=False)
        dataset_csv2=dataset_csv2.reset_index()
        #print(dataset_csv2.head())
